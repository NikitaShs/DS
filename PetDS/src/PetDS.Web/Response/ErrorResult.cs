...
namespace PetDS.Web.Response
{
    public class ErrorResult : IResult
    {
        ...
        public Task ExecuteAsync(HttpContext httpContext)
        {
            ...
            var typeError = _errors.Select(e => e.Type).Distinct().ToList();

            int statusCode = typeError.Count() > 1 ? StatusCodes.Status500InternalServerError : GetStatusError(typeError.First());
